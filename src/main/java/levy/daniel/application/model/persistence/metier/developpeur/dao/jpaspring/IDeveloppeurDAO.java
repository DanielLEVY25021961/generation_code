package levy.daniel.application.model.persistence.metier.developpeur.dao.jpaspring;
 ...
 *
 */
public interface IDeveloppeurDAO {
	 ...
	 * @throws Exception
	 */
	IDeveloppeur create(IDeveloppeur pObject) throws Exception;
	 ...
	 * @throws Exception
	 */
	void persist(IDeveloppeur pObject) throws Exception;
	 ...
	 * @throws Exception
	 */
	Long createReturnId(IDeveloppeur pObject) throws Exception;
	 ...
	 * <br/>
	 *
	 * @param pList : Iterable&lt;IDeveloppeur&gt; : 
	 * itérable d'objets métier à persister dans le stockage.<br/>
	 * 
	 * @return Iterable&lt;IDeveloppeur&gt; : 
	 * itérable d'objets métier persistés dans le stockage.<br/>
	 * 
	 * @throws Exception
	 */
	Iterable<IDeveloppeur> save(Iterable<IDeveloppeur> pList) throws Exception;
	 ...
	 * @throws Exception
	 */
	IDeveloppeur retrieve(IDeveloppeur pObject) throws Exception;
	 ...
	 * 
	 * @return : IDeveloppeur : objet métier recherché.<br/>
	 * 
	 * @throws Exception
	 */
	IDeveloppeur findById(Long pId) throws Exception;
	 ...
	 * @throws Exception
	 */
	Long retrieveId(IDeveloppeur pObject) throws Exception;
	 ...
	 *
	 * @return : List&lt;IDeveloppeur&gt; : 
	 * liste de tous les objets métier persistés dans le stockage.<br/>
	 * 
	 * @throws Exception
	 */
	List<IDeveloppeur> findAll() throws Exception;
	 ...
	 * (List&lt;IDeveloppeur&gt;) dont les IDs appartiennent 
	 * à la Collection itérable d'IDs passée en paramètre.</li>
	 * <li>Inclut dans la liste les sous-classe de IDeveloppeur 
	 * (strategy=InheritanceType.JOINED) 
	 * avec la visibilité (Typé) IDeveloppeur.</li>
	 * </ul>
	 ...
	 * 
	 * @return Iterable&lt;IDeveloppeur&gt; : List&lt;IDeveloppeur&gt;.<br/>
	 * 
	 * @throws Exception 
	 */
	Iterable<IDeveloppeur> findAll(Iterable<Long> pIds) throws Exception;
	 ...
	 * <br/>
	 *
	 * @param pObject : IDeveloppeur : objet métier avec ID 
	 ...
	 * @throws Exception 
	 */
	IDeveloppeur update(IDeveloppeur pObject) throws Exception;
	 ...
	 * @param pObjectModifie : IDeveloppeur : 
	 * Objet métier contenant les modifications 
	 * à apporter à l'objet persistant dans le stockage.<br/>
	 * 
	 * @return IDeveloppeur : objet métier persistant modifié.<br/>
	 * 
	 * @throws Exception
	 */
	IDeveloppeur update(Long pId, IDeveloppeur pObjectModifie) throws Exception;
	 ...
	 * <br/>
	 *
	 * @param pObject : IDeveloppeur : objet métier à détruire.<br/>
	 * 
	 * @return : boolean : 
	 ...
	 * @throws Exception
	 */
	boolean delete(IDeveloppeur pObject) throws Exception;
	 ...
	 * @throws Exception
	 */
	void deleteIterable(Iterable<IDeveloppeur> pList) throws Exception;
	 ...
	 * @throws Exception
	 */
	boolean deleteIterableBoolean(Iterable<IDeveloppeur> pList) throws Exception;
	 ...
	 * <br/>
	 *
	 * @param pObject : IDeveloppeur : objet métier à rechercher.<br/>
	 * 
	 * @return boolean : 
	 ...
	 * @throws Exception
	 */
	boolean exists(IDeveloppeur pObject) throws Exception;
	 ...
	 * <br/>
	 *
	 * @param pList : List&lt;IDeveloppeur&gt;.<br/>
	 * 
	 * @return : String.<br/>
	 */
	String afficherListeObjetsMetier(List<IDeveloppeur> pList);
	
	
	
} // FIN DE L'INTERFACE IDeveloppeurDAO.-----------------------------------------
