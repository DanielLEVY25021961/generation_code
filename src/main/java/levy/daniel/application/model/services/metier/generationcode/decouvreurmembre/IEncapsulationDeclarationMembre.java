...
public interface IEncapsulationDeclarationMembre extends 
	...
	*/
	...
	/**
	 * Getter du boolean qui stipule si le membre est juste <b>public</b>.
	 *
	 * @return this.publicSimple : boolean.<br/>
	 */
	boolean isPublicSimple();

	
	
	/**
	* Setter du boolean qui stipule si le membre est juste <b>public</b>.
	*
	* @param pPublicSimple : boolean : 
	* valeur à passer à this.publicSimple.<br/>
	*/
	void setPublicSimple(boolean pPublicSimple);


	
	/**
	 * Getter du boolean qui stipule si le membre est <b>public transient</b>.
	 *
	 * @return this.publicTransient : boolean.<br/>
	 */
	boolean isPublicTransient();


	
	/**
	* Setter du boolean qui stipule si le membre est <b>public transient</b>.
	*
	* @param pPublicTransient : boolean : 
	* valeur à passer à this.publicTransient.<br/>
	*/
	void setPublicTransient(boolean pPublicTransient);


	
	/**
	 * Getter du boolean qui stipule si le membre 
	 * est <b>public static final</b>.
	 *
	 * @return this.publicStaticFinal : boolean.<br/>
	 */
	...
	/**
	* Setter du boolean qui stipule si le membre 
	* est <b>public static final</b>.
	*
	* @param pPublicStaticFinal : boolean : 
	* valeur à passer à this.publicStaticFinal.<br/>
	*/
	void setPublicStaticFinal(boolean pPublicStaticFinal);
	 ...
	 *
	 * @return this.publicStaticFinalTransient : boolean.<br/>
	 */
	boolean isPublicStaticFinalTransient();
	...
	* <b>public static final transient</b>.
	*
	* @param pPublicStaticFinalTransient : boolean : 
	* valeur à passer à this.publicStaticFinalTransient.<br/>
	*/
	void setPublicStaticFinalTransient(boolean pPublicStaticFinalTransient);


	
	/**
	 * Getter du boolean qui stipule si le membre est <b>public static</b>.
	 *
	 * @return this.publicStatic : boolean.<br/>
	 */
	...
	/**
	* Setter du boolean qui stipule si le membre est <b>public static</b>.
	*
	* @param pPublicStatic : boolean : 
	* valeur à passer à this.publicStatic.<br/>
	*/
	void setPublicStatic(boolean pPublicStatic);
	 ...
	 *
	 * @return this.publicStaticTransient : boolean.<br/>
	 */
	boolean isPublicStaticTransient();
	...
	* <b>public static transient</b>.
	*
	* @param pPublicStaticTransient : boolean : 
	* valeur à passer à this.publicStaticTransient.<br/>
	*/
