...
/**
 * class EcriveurMetierConcreteClassForm :<br/>
 * .<br/>
 * <br/>
 *
 ...
 *
 */
public class EcriveurMetierConcreteClassForm extends AbstractEcriveurFichiersJavaDetaille {

	// ************************ATTRIBUTS************************************/
	/**
	 * CLASSE_ECRIVEUR_CONCRETECLASSFORM : String :<br/>
	 * "Classe EcriveurMetierConcreteClassForm".<br/>
	 */
	public static final String CLASSE_ECRIVEUR_CONCRETECLASSFORM 
		= "Classe EcriveurMetierConcreteClassForm";
	...
	private static final Log LOG 
		= LogFactory.getLog(EcriveurMetierConcreteClassForm.class);
	...
	*/
	public EcriveurMetierConcreteClassForm() {
...
} // FIN DE LA CLASSE EcriveurMetierConcreteClassForm.-----------------------------